...
class AddProductColorDialog extends StatefulWidget {
  const AddProductColorDialog({super.key});

  @override
  State<AddProductColorDialog> createState() => _AddProductColorDialogState();
}

class _AddProductColorDialogState extends State<AddProductColorDialog> {
        ...
        children: [
          ...
          Padding(
            ...
            child: Align(
              ...
              child: GestureDetector(
                onTap: () {
                  _openColorPicker(currentColor ?? theme.primaryColor);
                },
                child: ColorCircle(
                  productColor: currentColor ?? theme.primaryColor,
                ),
              ),
            ),
          ),
            ...
            children: [
              ...
              CustomElevatedButton(
                onPressed: images.isEmpty
                    ? null
                    : () {
                        productFormProvider.addProductColor(
                          ProductColor(
